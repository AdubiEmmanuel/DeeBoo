...
var time_lapse;
var timeDsp = document.getElementsByClassName('time_dsp');
var timeDsp_length = timeDsp.length;
var timeDsp_r = document.getElementsByClassName('time_dsp_r');
...
function countdown(submit) {
    ...
    if (time_remaining <= time_critical) {
        $(".time_dsp").toggleClass('text-danger', 'border rounded border-danger');
    }
